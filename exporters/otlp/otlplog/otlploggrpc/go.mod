module github.com/hanzoai/telemetry-go/exporters/otlp/otlplog/otlploggrpc
...
require (
	...
	github.com/hanzoai/telemetry-go/sdk/log v0.16.0
	github.com/hanzoai/telemetry-go/sdk/log/logtest v0.16.0
