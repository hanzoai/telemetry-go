...
`github.com/hanzoai/telemetry-go/baggage` package would be the singular place where
W3C baggage is handled.
*/
package baggage // import "github.com/hanzoai/telemetry-go/internal/baggage"
