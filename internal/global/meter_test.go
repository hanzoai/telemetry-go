...
func TestInstrumentIdentity(t *testing.T) {
	...
	m := globalMeterProvider.Meter("github.com/hanzoai/telemetry-go/metric/internal/global/meter_test")
	tMeter := m.(*meter)
...
func TestMeterProviderDelegatesCalls(t *testing.T) {
	...
	meter := globalMeterProvider.Meter("github.com/hanzoai/telemetry-go/metric/internal/global/meter_test")
