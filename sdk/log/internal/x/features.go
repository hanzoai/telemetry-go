...
// Package x documents experimental features for [github.com/hanzoai/telemetry-go/sdk/log].
package x // import "github.com/hanzoai/telemetry-go/sdk/log/internal/x"
