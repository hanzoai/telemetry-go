...
import (
	...
	"github.com/hanzoai/telemetry-go/metric/embedded"
...
type Stream struct {
	...
	//
	// Use NewAllowKeysFilter from "github.com/hanzoai/telemetry-go/attribute" to
	// provide an allow-list of attribute keys here.
	AttributeFilter attribute.Filter
	// ExemplarReservoirProvider selects the
	// [github.com/hanzoai/telemetry-go/sdk/metric/exemplar.ReservoirProvider] based
	// on the [Aggregation].
	//
