...
import (
	...
	"github.com/hanzoai/telemetry-go/trace/internal/telemetry"
)
...
var (
	...
	scope = &telemetry.Scope{
		Name:         "github.com/hanzoai/telemetry-go/trace/internal/telemetry/test",
		Version:      "v0.0.1",
	...
	pScope = func() pcommon.InstrumentationScope {
		...
		s.SetName("github.com/hanzoai/telemetry-go/trace/internal/telemetry/test")
		s.SetVersion("v0.0.1")
